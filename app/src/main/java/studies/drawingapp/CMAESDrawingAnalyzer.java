...
public class CMAESDrawingAnalyzer extends DrawingAnalyzer {
    private static final String TAG = "CMAESDrawingAnalyzer";
    ...
    public CMAESDrawingAnalyzer(Bitmap drawing, Bitmap model) {
